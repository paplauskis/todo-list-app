...
export const completedTodosSection = document.querySelector(
  '.completed-todos-section'
);
export const notesSection = document.querySelector('.notes-section');

const allTodosSectionButton = document.querySelector(
  '.all-todos-section-button'
);
const todayTodosSectionButton = document.querySelector(
  '.today-todos-section-button'
);
const tommorowTodosSectionButton = document.querySelector(
  '.tommorow-todos-section-button'
);
const lowPriorityTodosSectionButton = document.querySelector(
  '.low-priority-section-button'
);
const mediumPriorityTodosSectionButton = document.querySelector(
  '.medium-priority-section-button'
);
const highPriorityTodosSectionButton = document.querySelector(
  '.high-priority-section-button'
);
const notesSectionButton = document.querySelector('.notes-section-button');
const completedTodosSectionButton = document.querySelector(
  '.completed-todos-section-button'
);
...
export function sectionLoader(todoDiv) {
  lowPriorityTodosSectionButton.addEventListener('click', () =>
    loadLowPrioritySection(todoDiv)
  );
  mediumPriorityTodosSectionButton.addEventListener('click', () =>
    loadMediumPrioritySection(todoDiv)
  );
  highPriorityTodosSectionButton.addEventListener('click', () =>
    loadHighPrioritySection(todoDiv)
  );
  allTodosSectionButton.addEventListener('click', () =>
    loadAllTodosSection(todoDiv)
  );
  todayTodosSectionButton.addEventListener('click', () =>
    loadTodayTodosSection(todoDiv)
  );
  tommorowTodosSectionButton.addEventListener('click', () =>
    loadTommorowTodosSection(todoDiv)
  );
}
